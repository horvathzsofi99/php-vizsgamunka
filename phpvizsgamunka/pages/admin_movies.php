        ...
        if(isset($_POST['search'])){
                ...
                while($searchData = mysqli_fetch_assoc($searches)){
                    if($searchData['torolve'] == "nem"){
                        if(!(in_array($searchData['cim'], $movieArray))){
                            print("<a href=\"admin_movie_data_sheet.php?id=".$searchData['id']."\" class=\"text-decoration-none\">
                                    <div class=\"col\">
            ...
            while($movieData = mysqli_fetch_assoc($movies)){
                if($movieData['torolve'] == "nem"){
                    print("<a href=\"admin_movie_data_sheet.php?id=".$movieData['id']."\" class=\"text-decoration-none\">
                        <div class=\"col\">
                            <div class=\"card h-100\">
