...
?>
    ...
    <div class="row my-4">
        <div class="col-2">
            <img class="card-img-top" src="../assets/img/user/<?php print($_SESSION['picture']); ?>" alt="alt"/>
        </div>
        <div class="col-10">
            <form method="POST">
                <label for="comment" class="col-form-label">Szólj hozzá</label>
                <textarea id="comment" name="comment" class="w-100" required></textarea>
