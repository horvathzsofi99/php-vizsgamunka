            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="admin_add_movies.php">hozzáadás</a></li>
                        <li class="nav-item"><a class="nav-link" href="admin_edit_movies.php">módosítás</a></li>
                        <li class="nav-item"><a class="nav-link" href="home.php?login=false">Kijelentkezés</a></li>
